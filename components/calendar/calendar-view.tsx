      ...
      <div className="flex min-h-0 flex-1">
        ...
        <aside className="flex w-80 shrink-0 flex-col border-l border-border">
          <div className="flex items-center gap-2 border-b border-border px-5 py-3">
            ...
            <h2 className="text-[13px] font-bold tracking-tight text-foreground">Coming up</h2>
            ...
            <div className="space-y-1.5">
              {upcoming.map((c) => (
                <button
                  key={c.id}
                  onClick={() => open(c)}
                  className="relative flex w-full items-start gap-3 rounded-lg border border-border bg-card px-3 py-2.5 text-left transition-colors hover:border-ring/40"
                >
                  <span
